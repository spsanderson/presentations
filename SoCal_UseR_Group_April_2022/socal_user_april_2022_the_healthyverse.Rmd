...
This is a workflow, meaning we pipe certain commands together to get the data.
...
dist_comp_tbl <- hai_distribution_comparison_tbl(.x = df,
                                                 .distributions = c("beta"),
                                                 .normalize = FALSE)
dist_tbl <- hai_get_density_data_tbl(.data = dist_comp_tbl)

hai_density_plot(dist_tbl, distribution, x, y, .interactive = FALSE)
```
